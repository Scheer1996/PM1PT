...
public class Race {
	 ...
	 * 
	 * @param trackLength specifies how long the race track is going to be
	 */
	 ...
	 * 
	 * @param racecar the Racecar to be added
	 */
	...
	/**
	 * Performs the race by making all cars drive until one has completed the entire track
	 */
	public void perform(){
